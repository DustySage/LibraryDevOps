    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.IsLibrarian = Input.IsLibrarian;
                ...
                var roleName = Input.IsLibrarian ? "Librarian" : "Patron";
                var role = new IdentityRole(roleName);

                var addRoleResult = await _roleManager.CreateAsync(role);

                var addUserRoleResult = await _userManager.AddToRoleAsync(user, roleName);
